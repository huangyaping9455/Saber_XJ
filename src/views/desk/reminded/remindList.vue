      ...
      >
        ...
        >
          ...
          <el-form-item label="岗位">
            <el-input
              v-model="formLabelAlign.deptPoame"
              :disabled="disabled"
            ></el-input>
          </el-form-item>
...
<script>
import { selectYJDept, delYuJingByXiangId } from "@/api/dept/noticelist";
...
export default {
  ...
  methods: {
    ...
    viewRow(index, data) {
      ...
      this.formLabelAlign.region = data[index].yujingfenlei;
      this.formLabelAlign.type = data[index].title;
      this.formLabelAlign.deptName = data[index].deptName;
      this.formLabelAlign.deptPoame = data[index].postName;
      this.disabled = true;
    },
    // 删除
    ...
    befoExport() {
      ...
      let deptId = this.$store.getters.deptId;
      selectYJDept(deptId, 0, 0, this.account, this.deptNames).then((res) => {
